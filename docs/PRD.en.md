---
title: "Trendus (Stock Tracking App) - Product Requirements Document"
status: draft
created: 2026-09-15
updated: 2026-09-16
...
**Trendus** is an investment research app — for web and mobile — that evaluates stocks on the American (NYSE/NASDAQ) and Turkish (BIST) exchanges using the world's most widely used **fundamental analysis** parameters, plus a comprehensive **technical analysis** experience.
