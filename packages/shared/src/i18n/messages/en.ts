...
export const en: Messages = {
  ...
  simulation: {
    buyFromStockButton: "Buy in simulation",
    buyFromStockTitle: "Paper trade",
    selectSimulationLabel: "Simulation",
    cashAvailable: "Available cash: {amount}",
    estimatedCost: "Estimated cost: {amount}",
    buyButton: "Buy",
    buying: "Buying...",
    buySuccess: "Added {quantity} × {symbol} to the simulation.",
    goToSimulation: "Go to simulation",
    quickCreateHint: "Create a simulation first to start paper trading.",
    quickCreateButton: "Create simulation and continue",
    defaultSimulationName: "My simulation",
    title: "Simulations",
    backToDashboard: "← Back to dashboard",
