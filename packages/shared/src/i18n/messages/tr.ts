...
export const tr: Messages = {
  ...
  search: {
    ...
    label: "Hisse ara",
    placeholder: "Sembol veya şirket adı ara (örn. AAPL, Apple)",
    searching: "Aranıyor...",
  ...
  simulation: {
    buyFromStockButton: "Simülasyonda al",
    buyFromStockTitle: "Sanal alım",
    selectSimulationLabel: "Simülasyon",
    cashAvailable: "Kullanılabilir nakit: {amount}",
    estimatedCost: "Tahmini tutar: {amount}",
    buyButton: "Satın al",
    buying: "Alınıyor...",
    buySuccess: "{quantity} adet {symbol} simülasyona eklendi.",
    goToSimulation: "Simülasyona git",
    quickCreateHint: "Sanal alım yapmak için önce bir simülasyon oluştur.",
    quickCreateButton: "Simülasyon oluştur ve devam et",
    defaultSimulationName: "Simülasyonum",
    title: "Simülasyonlar",
    backToDashboard: "← Panele dön",
