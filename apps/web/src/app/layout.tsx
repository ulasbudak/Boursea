...
const THEME_INIT_SCRIPT = `(function(){try{var t=localStorage.getItem('trendus-theme');if(t==='light'||t==='dark'){document.documentElement.setAttribute('data-theme',t);}}catch(e){}})();`;
